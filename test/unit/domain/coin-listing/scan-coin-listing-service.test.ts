...
const getAnnouncementServiceMock = jest.mocked(jest.genMockFromModule<GetAnnouncementService>('../../../../src/code/domain/announcement/get-announcement-service'), true);
const coinListingRepositoryMock = jest.mocked(jest.genMockFromModule<CoinListingRepository>('../../../../src/code/domain/coin-listing/coin-listing-repository'), true);
const coinListingPublisherMock = jest.mocked(jest.genMockFromModule<CoinListingPublisher>('../../../../src/code/domain/coin-listing/coin-listing-publisher'), true);
