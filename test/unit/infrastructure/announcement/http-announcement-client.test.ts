...
const binanceAnnouncementClientMock = jest.mocked(jest.genMockFromModule<BinanceAnnouncementClient>('../../../../src/code/infrastructure/announcement/exchanges/binance/binance-announcement-client'), true);
